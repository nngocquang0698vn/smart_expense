...
const _vi = {
  ...
  "clearAllDataMessage":
      "Thao tác này sẽ xoá toàn bộ giao dịch hiện tại để bạn bắt đầu lại phần demo. Danh mục và cài đặt vẫn được giữ nguyên.",
  "clearAllDataConfirm": "Xoá tất cả",
  "clearAllDataSuccess": "Đã xoá tất cả dữ liệu giao dịch.",
  "demoReviewSeedSuccess": "Đã tạo giao dịch demo cần đối soát.",
  ...
  "reviewReminderEnabledSubtitle":
      "Nhận lời nhắc để kiểm tra lại các giao dịch đang chờ đối soát.",
  "reviewReminderModeLabel": "Chế độ nhắc",
  "reviewReminderModeEndOfDay": "Cuối ngày",
  "reviewReminderModeInterval": "Theo khoảng thời gian",
  "reviewReminderEndOfDayDescription":
      "App sẽ nhắc bạn kiểm tra các giao dịch chưa đối soát vào cuối ngày.",
  "reviewReminderIntervalDescription":
      "App sẽ kiểm tra định kỳ trong khung giờ bạn chọn và chỉ nhắc nếu còn giao dịch cần đối soát.",
  "reviewReminderEndOfDayTime": "Giờ nhắc cuối ngày",
  "reviewReminderStartTime": "Giờ bắt đầu",
  "reviewReminderEndTime": "Giờ kết thúc",
  "reviewReminderIntervalHours": "Lặp lại mỗi",
  "reviewReminderPermissionRequired":
      "Bạn cần bật quyền thông báo để app có thể nhắc đối soát giao dịch.",
  "reviewReminderPermissionBlocked":
      "Trình duyệt đang chặn thông báo. Bạn có thể bật lại trong phần cài đặt của trình duyệt.",
  "reviewReminderDisabled": "Đã tắt nhắc đối soát giao dịch.",
  "hourUnit": "tiếng",
  ...
  "noPending": "Xong rồi! Các giao dịch cần đối soát đã được xử lý.",
  ...
  "notificationOpenedPending": "Đã chuyển tới màn hình đối soát.",
